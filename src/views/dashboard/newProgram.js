    ...
    <li class="nav-item">
        <a href="../../index.html" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon">
            <img src="../../assets/img/brand/igire.jpg" height="40" width="40" alt="Volt Logo"/>
          </span>
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse "
          ...
          <ul class="flex-column nav">
            <li class="nav-item ">
            <a href="/program" target="_blank" class="btn btn-secondary d-inline-flex align-items-center me-3">
